...
func (d *CffslAccessor) GetCertificatesByID(id string) (crs []CertRecord, err error) {
...
func (d *CffslAccessor) RevokeCertificatesByID(id string, reasonCode int) (crs []CertRecord, err error) {
	err = d.checkDB()
	if err != nil {
		return nil, err
	}
